...
export const userRecoveryFields = {
  ...
  accountRecoveryTokenExpiry: timestamp(
    'account_recovery_token_expiry',
  ).defaultNow(),
  accountRecoveryRequestedAt: timestamp(
  ...
  accountRecoveryVerificationToken: text(
    'account_recovery_verification_token',
  ).default(''),
  accountRecoveryVerificationTokenExpiry: timestamp(
    'account_recovery_verification_token_expiry',
  ).defaultNow(),
  accountRecoveryVerificationRequestedAt: timestamp(
